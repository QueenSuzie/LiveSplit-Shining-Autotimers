...
update
{
	...
	//Normal stages
	else if (current.mainMenu1 == 0 && current.stageSelect == 0 && current.storyRecap == 0 && current.twoplayerMenu == 0 && current.currMenuState != 2 && current.currMenuState != 3 && current.currMenuState != 6 && 
